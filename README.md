...
This website serves as the digital storefront for Technited Minds, showcasing our active projects, research initiatives, and core competencies. The design philosophy combines a futuristic aesthetic with a clean, intuitive user experience.
...
- **Deployment**: Hosted on a standard web server.
...
1.  **Clone the repository**:
    ```bash
    git clone https://github.com/TechnitedMinds/TechnitedMinds.git
    ```
...
npm run build
```
The optimized and minified files will be placed in the `dist/` directory, ready for deployment.
